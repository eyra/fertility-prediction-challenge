...
# Process subcommand
process_parser = subparsers.add_parser("predict", help="Process input data.")
process_parser.add_argument("input_path", help="Path to input CSV file.")
...
score_parser.add_argument("prediction_path", help="Path to prediction CSV file.")
score_parser.add_argument("ground_truth_path", help="Path to outcome CSV file.")
score_parser.add_argument("--output", help="Path to score output CSV file.")
...
def predict_outcomes(df):
    ...
    # and returns a new DataFrame comprising two columns: nomem_encr and
    # prediction. The nomem_encr column in the new DataFrame replicates the
    # corresponding column from the input DataFrame. Meanwhile, the prediction
    # column includes predictions for each corresponding nomem_encr. Each
...
def score(prediction_path, ground_truth_path, output):
    """Score the predictions and write the metrics.
    
    This function takes the path to a CSV file containing predictions and the
    path to a CSV file containing the ground truth. It calculates the accuracy,
    precision, recall, and F1 score of the predictions and writes them to a new
    CSV file.
    ...
    # Write metrics to a new CSV file
